...
public interface PropertyMapper extends StaticTableDaoSupport<Property, PropertyExample, PropertyKey> {
     ...
     */
    @Insert({
        "insert into PROPERTY (PROPERTY_ID, ORDER_ID, ",
        "MERCHANT_ID, APP_ID, ",
        "OPEN_ID, PRODUCT_ID, ",
        ...
        "STATUS)",
        "values (#{propertyId,jdbcType=CHAR}, #{orderId,jdbcType=VARCHAR}, ",
        "#{merchantId,jdbcType=VARCHAR}, #{appId,jdbcType=VARCHAR}, ",
        "#{openId,jdbcType=VARCHAR}, #{productId,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "PROPERTY_ID, ORDER_ID, MERCHANT_ID, APP_ID, OPEN_ID, PRODUCT_ID, PROPERTY_TYPE, ",
        "ADDRESS, ORIGIN_OPENID, IS_SELF_SUPPORT, PRODUCT_DESC, IS_DIGIT, SIGN_TYPE, ",
        "PROPERTY_NAME, UNIT, MIN_COUNT, COUNT, URL, AMOUNT, DESCRIPTION, CREATE_TIME, ",
        "STATUS",
        "from PROPERTY",
        "where PROPERTY_ID = #{propertyId,jdbcType=CHAR}"
    })
