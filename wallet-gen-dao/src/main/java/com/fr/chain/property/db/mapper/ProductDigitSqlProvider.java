...
import com.fr.chain.property.db.entity.ProductDigitExample.Criterion;
import com.fr.chain.property.db.entity.ProductDigitExample;
import java.util.List;
import java.util.Map;

public class ProductDigitSqlProvider {
     ...
     */
    public String countByExample(ProductDigitExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("PRODUCT_DIGIT");
     ...
     * @mbggenerated Fri Feb 24 10:10:34 CST 2017
     */
    public String deleteByExample(ProductDigitExample example) {
        BEGIN();
        DELETE_FROM("PRODUCT_DIGIT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Fri Feb 24 10:10:34 CST 2017
     */
    public String insertSelective(ProductDigit record) {
        BEGIN();
        INSERT_INTO("PRODUCT_DIGIT");
        ...
        if (record.getChainType() != null) {
            VALUES("CHAIN_TYPE", "#{chainType,jdbcType=INTEGER}");
        }
        ...
        if (record.getPropertyCode() != null) {
            VALUES("PROPERTY_CODE", "#{propertyCode,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Fri Feb 24 10:10:34 CST 2017
     */
    public String selectByExample(ProductDigitExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProductDigit record = (ProductDigit) parameter.get("record");
        ProductDigitExample example = (ProductDigitExample) parameter.get("example");
        ...
        if (record.getChainType() != null) {
            SET("CHAIN_TYPE = #{record.chainType,jdbcType=INTEGER}");
        }
        ...
        if (record.getPropertyCode() != null) {
            SET("PROPERTY_CODE = #{record.propertyCode,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Fri Feb 24 10:10:34 CST 2017
     */
    public String updateByPrimaryKeySelective(ProductDigit record) {
        BEGIN();
        UPDATE("PRODUCT_DIGIT");
        ...
        if (record.getChainType() != null) {
            SET("CHAIN_TYPE = #{chainType,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Fri Feb 24 10:10:34 CST 2017
     */
    protected void applyWhere(ProductDigitExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
