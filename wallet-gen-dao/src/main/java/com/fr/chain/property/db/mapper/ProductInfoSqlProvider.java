...
public class ProductInfoSqlProvider {
    ...
    public String insertSelective(ProductInfo record) {
        ...
        if (record.getPropertyCode() != null) {
            VALUES("PROPERTY_CODE", "#{propertyCode,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPropertyCode() != null) {
            SET("PROPERTY_CODE = #{record.propertyCode,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(ProductInfo record) {
        ...
        if (record.getPropertyCode() != null) {
            SET("PROPERTY_CODE = #{propertyCode,jdbcType=INTEGER}");
        }
